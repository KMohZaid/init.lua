return {
  ...
  -- Main LSP Configuration, copied template from https://www.lazyvim.org/plugins/lsp#nvim-lspconfig [Full spec]
  {
    ...
    config = vim.schedule_wrap(function(_, opts)
      ...
      --
      -- auto command for float (not added, bcz i am using virtual line)
      -- cc : https://neovim.discourse.group/t/how-to-show-diagnostics-on-hover/3830/5
      --
      -- for virtual line idea
      -- cc : https://www.reddit.com/r/neovim/comments/1jm5atz/replacing_vimdiagnosticopen_float_with_virtual/
      --
      --
      vim.diagnostic.config({
        virtual_text = { -- text on right of line
          source = true, -- display which lsp is giving this diagnostic
          current_line = false, -- don't display on current line, because we will have virtual line
          spacing = 2,
          prefix = "●",
          suffix = "",
        },
